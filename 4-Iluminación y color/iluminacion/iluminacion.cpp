...
//  lspecular[]={1.f,1.f,1.f,1}, // luz especular
  lambient[]={1.f,1.f,1.f,1.f}, // luz ambiente
  ldiffuse[]={1.f,1.f,1.f,1.f}, // luz difusa
...
//  glLightModeli(GL_LIGHT_MODEL_LOCAL_VIEWER,1);
  ...
  float blanco[]={1.f,1.f,1.f,.5f};
  glMaterialfv(GL_FRONT_AND_BACK,GL_SPECULAR,blanco);// refleja blanco
  glMateriali(GL_FRONT_AND_BACK,GL_SHININESS,100);
  // habilita el cambio "al vuelo" de color del material
  glColorMaterial(GL_FRONT_AND_BACK,GL_AMBIENT_AND_DIFFUSE);
  glEnable(GL_COLOR_MATERIAL);
  */
  float fa[]={0.f,0.f,0.f,1.f},fd[]={0.f,0.f,0.f,1.f},fs[]={0.f,0.f,0.f,1.f},black[]={0,0,0,0};
