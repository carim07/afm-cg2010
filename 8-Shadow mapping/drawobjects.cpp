...
extern int lod,w,h;
extern bool wire,relleno,animado,smooth,cl_info;
...
void drawColorCube(){
  ...
  if (relleno){
    ...
    glBegin(GL_QUADS);
      ...
      glColor3f(1,0,0); glVertex3i(1,0,0);//color fijo

      //b=1 normal hacia +b
      glColor3f(0,0,1); glVertex3i(0,0,1);
      glColor3f(1,0,1); glVertex3i(1,0,1);
      glColor3f(1,1,1); glVertex3i(1,1,1);
      glColor3f(0,1,1); glVertex3i(0,1,1);//color fijo

      //g=0 normal hacia -g
      glColor3f(0,0,0); glVertex3i(0,0,0);
      glColor3f(1,0,0); glVertex3i(1,0,0);
      glColor3f(1,0,1); glVertex3i(1,0,1);
      glColor3f(0,0,1); glVertex3i(0,0,1);//color fijo

      //g=1 normal hacia +g
      glColor3f(0,1,0); glVertex3i(0,1,0);
      glColor3f(0,1,1); glVertex3i(0,1,1);
      glColor3f(1,1,1); glVertex3i(1,1,1);
      glColor3f(1,1,0); glVertex3i(1,1,0);//color fijo

      //r=0 normal hacia -r
      glColor3f(0,0,0); glVertex3i(0,0,0);
      glColor3f(0,0,1); glVertex3i(0,0,1);
      glColor3f(0,1,1); glVertex3i(0,1,1);
      glColor3f(0,1,0); glVertex3i(0,1,0);//color fijo
  ...
  else if (wire&&!relleno){ // si esta relleno no tiene sentido esto
    // aristas
...
void drawPlanoMovil(){
  ...
  if (wire&&!relleno&&!desde_aca){ // sin relleno ==> oculta lineas
    ...
    glShadeModel(GL_FLAT); // ni interpola color
  ...
  glVertex3i(0,0,1);
  glEnd();
  glPopAttrib(); // aca por si hay material
  glColor4fv(face_color);
